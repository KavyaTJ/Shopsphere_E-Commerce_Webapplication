    ...
    return(
      <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            ...
            role='combobox'
            aria-expanded={open}
            className="w-full max-w-full relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
                    ...
                    <CommandEmpty>No category found</CommandEmpty>
                        ...
                        {categories.map((category)=>(
                         ...
                         className={cn("ml-auto h-4 w-4",
                            value === category._id ? 'opacity-100':'opacity-0')}></Check>
                            </CommandItem>))}
                        </CommandGroup>
